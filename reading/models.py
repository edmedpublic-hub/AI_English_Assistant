...
class ReadingLesson(models.Model):
    ...
    unit = models.ForeignKey(
        ...
        null=True,   # ✅ allow nulls temporarily for migration
        blank=True
    )
    content = models.TextField()  # ✅ plain text for simplicity
    order = models.PositiveIntegerField(default=0)
...
class PronunciationAttempt(models.Model):
    user = models.ForeignKey(
        ...
        on_delete=models.SET_NULL, related_name="pron_attempts"
    )
    lesson = models.ForeignKey(
        "ReadingLesson", null=True, blank=True,
        on_delete=models.SET_NULL, related_name="pron_attempts"
    )
