...
# Verb detection pattern.
# Strategy: modals and auxiliaries explicitly listed,
# then broad patterns for regular conjugations.
# This catches topic-specific verbs like "yearned",
# "proclaimed", "descended" that a hardcoded list misses.
COMMON_VERB_PATTERNS = re.compile(
    r'\b('
    # ── Auxiliaries and modals (explicit) ─────────────
    r'is|are|was|were|am|be|been|being|'
    r'has|have|had|'
    r'do|does|did|'
    r'will|would|shall|should|'
    r'can|could|may|might|must|'
    # ── Common irregular verbs (explicit) ─────────────
    r'go|goes|went|gone|'
    r'come|comes|came|'
    r'get|gets|got|'
    r'make|makes|made|'
    r'take|takes|took|taken|'
    r'see|sees|saw|seen|'
    r'know|knows|knew|known|'
    r'think|thinks|thought|'
    r'give|gives|gave|given|'
    r'find|finds|found|'
    r'tell|tells|told|'
    r'run|runs|ran|'
    r'keep|keeps|kept|'
    r'begin|begins|began|begun|'
    r'write|writes|wrote|written|'
    r'speak|speaks|spoke|spoken|'
    r'grow|grows|grew|grown|'
    r'lose|loses|lost|'
    r'lead|leads|led|'
    ...
    r'put|puts|'
    r'let|lets|'
    r'show|shows|showed|shown|'
    r'hear|hears|heard|'
    r'eat|eats|ate|eaten|'
    r'drink|drinks|drank|drunk|'
    r'rise|rises|rose|risen|'
    r'choose|chooses|chose|chosen|'
    r'draw|draws|drew|drawn|'
    r'throw|throws|threw|thrown|'
    r'fly|flies|flew|flown|'
    r'drive|drives|drove|driven|'
    r'ride|rides|rode|ridden|'
    r'forget|forgets|forgot|forgotten|'
    r'forgive|forgives|forgave|forgiven|'
    r'understand|understands|understood|'
    r'become|becomes|became|'
    r'begin|begins|began|'
    r'build|builds|built|'
    r'burn|burns|burned|burnt|'
    r'catch|catches|caught|'
    r'fight|fights|fought|'
    r'teach|teaches|taught|'
    r'think|thinks|thought|'
    r'seek|seeks|sought|'
    r'sell|sells|sold|'
    r'spend|spends|spent|'
    r'stand|stands|stood|'
    r'sleep|sleeps|slept|'
    r'sweep|sweeps|swept|'
    r'swing|swings|swung|'
    r'mean|means|meant|'
    r'meet|meets|met|'
    r'shoot|shoots|shot|'
    r'sing|sings|sang|sung|'
    r'sink|sinks|sank|sunk|'
    r'swim|swims|swam|swum|'
    r'swing|swings|swung|'
    r'wake|wakes|woke|woken|'
    r'wear|wears|wore|worn|'
    # ── Regular conjugation patterns ──────────────────
    # These three patterns catch the vast majority of
    # regular English verbs without needing to list them.
    # \w+ed  — past tense:      yearned, walked, studied
    # \w+ing — present participle: yearning, walking
    # \w+s   — third person singular: yearns, walks
    # Note: \w+s also matches nouns (books, students)
    # but false positives are acceptable — missing a real
    # verb is worse than accepting a noun ending in s.
    r'\w+ed|'
    r'\w+ing|'
    r'\w+s'
    r')\b',
